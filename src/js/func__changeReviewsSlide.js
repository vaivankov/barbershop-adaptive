...
window.changeReviewsSlide = function () {
  ...
  let sourceDesktopJPG = document.querySelector(".reviews__source-desktop-jpg");
  let sourceTabletWEBP = document.querySelector(".reviews__source-tablet-webp");
  let sourceTabletJPG = document.querySelector(".reviews__source-tablet-jpg");
  let sourceMobileWEBP = document.querySelector(".reviews__source-mobile-webp");
